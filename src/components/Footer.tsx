    ...
    <footer className={classes.footer}>
      <div className={classes.inner}>
        <Container p="xl">
          <Stack gap="xl">
            <SimpleGrid cols={4}>
              <Anchor href="https://www.medplum.com/docs/tutorials/api-basics/create-fhir-data">Getting started GitBash</Anchor>
            ...
            <Text c="dimmed" size="sm">
              &copy; {new Date().getFullYear()} Foo Medical, Inc. All rights reserved. Hello World
            </Text>
          </Stack>
        </Container>
      </div>
